...
let seedpw = process.env.SEEDPW ? process.env.SEEDPW : '4321'
...
session.run(`CREATE
(sharkweek:User {name: 'shark@week.com', email:'shark@week.com',password: {password}, salt:{salt}, createdDate: {dateTime},isAdmin:true}),
(dragonslayer:User {name:'dragon@slayer.com', email:'dragon@slayer.com', password: {password}, salt:{salt}, createdDate: {dateTime},isAdmin:false}),
(superfly:User {name:'super@fly.com', email:'super@fly.com',password: {password}, salt:{salt}, createdDate: {dateTime}, isAdmin:false}),
(testUser:User {name:'test@user.com', email:'test@user.com',password: {password}, salt:{salt}, createdDate: {dateTime}, isAdmin:false}),
(user1:User {name:'user1@user.com', email:'user1@user.com',password: {password}, salt:{salt}, createdDate: {dateTime}, isAdmin:false}),
(user2:User {name:'user2@user.com', email:'user2@user.com',password: {password}, salt:{salt}, createdDate: {dateTime}, isAdmin:false}),
(user3:User {name:'user3@user.com', email:'user3@user.com',password: {password}, salt:{salt}, createdDate: {dateTime}, isAdmin:false}),

(user4:User {name:'user4@user.com', email:'user4@user.com',password: {password}, salt:{salt}, createdDate: {dateTime}, isAdmin:false}),
(user5:User {name:'user5@user.com', email:'user5@user.com',password: {password}, salt:{salt}, createdDate: {dateTime}, isAdmin:false}),
(user6:User {name:'user6@user.com', email:'user6@user.com',password: {password}, salt:{salt}, createdDate: {dateTime}, isAdmin:false}),
(user7:User {name:'user7@user.com', email:'user7@user.com',password: {password}, salt:{salt}, createdDate: {dateTime}, isAdmin:false}),
(user8:User {name:'user8@user.com', email:'user8@user.com',password: {password}, salt:{salt}, createdDate: {dateTime}, isAdmin:false}),
(user9:User {name:'user9@user.com', email:'user9@user.com',password: {password}, salt:{salt}, createdDate: {dateTime}, isAdmin:false}),
