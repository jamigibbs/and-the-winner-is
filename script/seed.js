...
(swvote1:Vote {name:'Vote', status:'previous', createdDate: {dateTime} }),
(swvote2:Vote {name:'Vote', status:'previous', createdDate: {dateTime} }),
...
(dsvote1:Vote {name:'Vote', status:'latest', createdDate: {dateTime}}),
(dragonslayer)-[:VOTED]->(dsvote1),
(dsvote1)-[:FRAMEWORK]->(React),

(superfly)-[:LOCATION]->(AU),
(sfvote1:Vote {name:'Vote', status:'previous', createdDate: {dateTime}}),
